...
public class ComputeTax {
	...
	public static void main(String[] args) {
		...
		System.out.print("(0-Single filer, 1-married jointly or" + "qualifing widow(er), 2-Married seperately, 3-head of " 
		...
		if (status == 0) {// compute tax for single filers
			if (taxableIncome <= 8350)
				...
				tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + (82250 - 33950) * 0.25 + (171550 - 82250) * 0.28 + (372950 - 171550) * 0.33 + (taxableIncome -372951) * 0.35;
		}
		
		else if (status == 1) {//married couple filing jointly or qualifying widower
			if (taxableIncome <= 16700)
				...
				tax = 16700 * 0.10 + (67900 - 16700) * 0.15 + (137050 - 67900) * 0.25 + (208850 - 137050) * 0.28 + (372950 - 208850) * 0.33 + (taxableIncome -372951) * 0.35;
		}
			...
			if (taxableIncome <= 8350)
				...
				tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + (68525 - 33950) * 0.25 + (104425 - 68525) * 0.28 + (186475 - 104425) * 0.33 + (taxableIncome -186476) * 0.35;
		} 
			...
			if (taxableIncome <= 11950)
				...
				tax = 11950 * 0.10 + (45500 - 11950) * 0.15 + (117450 - 45500) * 0.25 + (190200 - 117450) * 0.28 + (372950 - 190200) * 0.33 + (taxableIncome -372951) * 0.35;
		}
